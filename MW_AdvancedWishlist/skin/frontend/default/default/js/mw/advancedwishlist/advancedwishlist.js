...
MW.AdvancedWishist = {
    ...
    addToWishlistUrl : null,
    /*------------------ Event ----------------------------------------*/

    beforeAddHandler:[],
    addBeforeAddToWishlistEvent:function(functionName,scope){
    ...
    //---------------------------------------------------------------------
    afterAddHandler:[],
    addAfterAddToWishlistEvent:function(functionName){
        if(typeof(scope) == "undefined") scope = "defaultcase";
    ...
    CurrentRequest: null,
    addToWishlist:function(productId,callback,scope){
        var $this = this;

        if($this.addToWishlistUrl == null){
            throw "addToWishlistUrl is Null";
        }
        $this.excHander("before_addtowishlist",$this,scope);
        $this.preRequestData(productId);
        jQuery.post(
            $this.addToWishlistUrl,
            $this.CurrentRequest,
            function(response){
                ...
                $this.excHander("after_addtowishlist",$this,scope);
            },'json'
        );
    },
